...
현대인의 할 일은 점점 복잡해지는데, 기존의 관리 도구는 단순한 ‘나열’에 머물러 있어 일정의 맥락이 엉키고 시각적 피로감이 발생합니다. **Pebble**은 이러한 문제를 해결하기 위해 **Category → Milestone → Task의 3단계 계층 구조**를 도입하여, 사용자가 지금 하는 일이 어떤 상위 목표를 위한 과정인지 한눈에 조망하고 핵심 데드라인을 놓치지 않도록 돕는 개인 맞춤형 에센셜 프로덕트입니다.
